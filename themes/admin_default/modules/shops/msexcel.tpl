...
<div class="control m-bottom">
	...
	<div class="pull-right">
		<a href="{URL_DOWNLOAD}" target="_blank" class="btn btn-primary btn-xs"><em class="fa fa-download">&nbsp;</em>{LANG.export}</a>
		<a href="{URL_IMPORT}" class="btn btn-primary btn-xs"><em class="fa fa-folder-o">&nbsp;</em>{LANG.import}</a>
	</div>
